module.exports = {
    ...
    "import google account sign in": "Importer vos données de Google",
    ...
    "email caption": "Pour accéder à vos emails depuis votre Cozy, configurer votre compte.",
    "email email": "email",
    "email email tip": "Vous pourrez ajouter d'autres comptes mails plus tard.",
    "email password": "mot de passe",
    "email imap server": "serveur imap",
    "email imap port": "port",
    "email imap ssl": "Utiliser SSL ?",
    "email show advanced": "Afficher les paramètres avancés",
    ...
    "welcome message": "Avec Cozy, vous pouvez désormais stocker vos données dans votre propre cloud personnel. Contrairement aux autres services cloud, aucun de vos données ne sont analysées ou exploitées !"
}
;
