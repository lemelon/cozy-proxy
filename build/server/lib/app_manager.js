...
var AppManager, Client, fs, logger;
...
AppManager = (function() {
  ...
  AppManager.prototype.startStaticApp = function(appName, url, path, callback) {
    logger.info("Starting static app " + appName);
    if (url === '/' || url === '/public/') {
      url += 'index.html';
    }
    return fs.readFile(path + url, 'utf8', function(err, content) {
